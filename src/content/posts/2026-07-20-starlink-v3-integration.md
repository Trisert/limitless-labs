...
So the optical communications people point to as the source of the leap are real, but they are the _backbone_, not the user link. They are what make the aggregation _sustainable_.
...
The real lesson for anyone building in this space: the winner isn't the one with the most powerful satellite. It's the one who controls whichever constraint is binding _right now_ — today, that's integration from factory to orbit. Tomorrow, it may be the ability to do it small.
